...
//Implementing two dimensional array	
	...
	public static String [] month={"JANURARY", "FEBURARY","MARCH","APRIL","MAY","JUNE","JULY","AUGUST","SEPTEMBER","OCTOBER","NOVEMBER","DECEMBER"};
...
//Method to calculate the higest temp
	...
	public static void displayTemp(int[][]arrayTemp){
		...
		System.out.println("Lowest temperature month:"+calcLowTemp(arrayTemp));
		System.out.println("Highest temperature month:"+calcHighTemp(arrayTemp));	
	}	
}